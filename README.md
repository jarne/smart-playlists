...
It is a side project and not all the scripts are perfectly tested, although worked
for me when running them.
Furthermore, most of the code is generated by AI as it are mostly simple actions to perform.

### Available scripts

- **`liked-date.py`**: Split your liked songs into playlists separated by year and month (2020 July, 2020 August, ...). This script will create or update (if existing) playlists for each month and leave your liked songs untouched.
